...
function _walk() {
  _walk = _wrapAsyncGenerator(function* (dir) {
    ...
    try {
      for (var _iterator = _asyncIterator(yield _awaitAsyncGenerator(opendir(dir))), _step, _value; _step = yield _awaitAsyncGenerator(_iterator.next()), _iteratorNormalCompletion = _step.done, _value = yield _awaitAsyncGenerator(_step.value), !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
        const d = _value;
  ...
  try {
    for (var _iterator2 = _asyncIterator(pathArray), _step2, _value2; _step2 = await _iterator2.next(), _iteratorNormalCompletion2 = _step2.done, _value2 = await _step2.value, !_iteratorNormalCompletion2; _iteratorNormalCompletion2 = true) {
      ...
      try {
        ...
        try {
          for (var _iterator3 = _asyncIterator(walk(path)), _step3, _value3; _step3 = await _iterator3.next(), _iteratorNormalCompletion3 = _step3.done, _value3 = await _step3.value, !_iteratorNormalCompletion3; _iteratorNormalCompletion3 = true) {
