export const VALIDATION_RULES : StringIndexed = {
  ...
  password: /^(?=.*[A-Z])(?=.*\d).{8,40}$/,
  old_password: /^(?=.*[A-Z])(?=.*\d).{8,40}$/,
  new_password: /^(?=.*[A-Z])(?=.*\d).{8,40}$/,
  new_password_confirm: /^(?=.*[A-Z])(?=.*\d).{8,40}$/,
  phone: /^\+?[0-9]{10,15}$/,
...
export const VALIDATION_ERRORS : StringIndexed = {
  add_user_id: 'Длина от 1 до 10 символов, может содержать только цифры',
  remove_user_id: 'Длина от 1 до 10 символов, может содержать только цифры',
  ...
  old_password: 'Длина от 8 до 40 символов, обязательно хотя бы одна заглавная буква и цифра.',
  new_password: 'Длина от 8 до 40 символов, обязательно хотя бы одна заглавная буква и цифра.',
  new_password_confirm: 'Длина от 8 до 40 символов, обязательно хотя бы одна заглавная буква и цифра.',
